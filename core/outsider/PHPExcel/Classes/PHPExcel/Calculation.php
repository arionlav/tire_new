...
class PHPExcel_Calculation {
	...
	const RETURN_ARRAY_AS_VALUE = 'valuezzz';
...
//		}
	...
	private function _executeBinaryComparisonOperation($cellID, $operand1, $operand2, $operation, &$stack, $recursingArrays=FALSE) {
		...
		//	executeQuery the necessary operation
		switch ($operation) {
			//	Greater than
			case '>':
	...
	private function _executeNumericBinaryOperation($cellID,$operand1,$operand2,$operation,$matrixFunction,&$stack) {
		...
		if ((is_array($operand1)) || (is_array($operand2))) {
			...
			if ((PHPExcel_Calculation_Functions::getCompatibilityMode() != PHPExcel_Calculation_Functions::COMPATIBILITY_OPENOFFICE) &&
				...
				//	If we're dealing with non-matrix operations, executeQuery the necessary operation
				switch ($operation) {
					//	Addition
					case '+':
						$result = $operand1 + $operand2;
