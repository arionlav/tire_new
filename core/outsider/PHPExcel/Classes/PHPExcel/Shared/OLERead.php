...
class PHPExcel_Shared_OLERead {
    ...
    <link rel="stylesheet" href="style.css" type="text/css" />
        ...
        <p>Возникла ошибка. Обратитесь к системному администратору.<p>
    </div>
    <div style="text-align: center; margin-top: 5%; font: 16px 'Calibri'">
        <a href="tire.php" style="color: midnightblue; text-decoration: none">Попробовать еще раз</a><br/>
        <a href="index.php" style="color: midnightblue; text-decoration: none; margin-top: 10px; display:block">В главное меню</a>
    </div>
LABEL;
            exit;
