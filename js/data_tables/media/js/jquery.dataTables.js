...
/*$(function() {
 $("#tableOrdersToday").on("click", "td", function(){ // for save event
 $('.showParam').toggle();
 });
...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"oAria": {
				 ...
				 *    } );
				 */
				"sSortAscending": ": Сортировка по убыванию",
				 ...
				 *    } );
				 */
				"sSortDescending": ": Сортировка по возрастанию"
			},
			 ...
			 *    } );
			 */
			"sInfo": "Показаны строки: с <span>_START_</span> по <span>_END_</span><br/> Всего строк в этом разделе: <span>_TOTAL_</span>",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Показано строк с 0 по 0 из 0",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(Выбрано из всех _MAX_ строк)",
			 ...
			 *    } );
			 */
			"sZeroRecords": "Ничего не нашли по данному запросу"
		},
	...
	DataTable.defaults.column = {
		 ...
		 *      executeQuery a function of the name given. For example: `browser()` for a
